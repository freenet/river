...
mod tests {
    ...
    fn registry_values_and_order_are_stable_across_codegen_changes() {
        ...
        //
        // V32 registers the pre-held-set-sweep generation (freenet/river#671):
        // `DirectMessagesV1::apply_delta` left held DMs with a non-member
        ...
        //
        // V33 registers the pre-orphaned-ban-drop generation (freenet/river#423,
        // PR #702): `BansV1::apply_delta` rejected a WHOLE delta on the
        // orphaned-ban rule judged against the pre-update member set, which
        // could fork a room permanently.

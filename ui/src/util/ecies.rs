...
mod tests {
    ...
    fn seal_for_room_call_sites_pinned() {
        let nickname_src = crate::util::strip_comments(include_str!(
            "../components/members/member_info_modal/nickname_field.rs"
        ));
        let room_name_src =
            crate::util::strip_comments(include_str!("../components/room_list/room_name_field.rs"));
        let edit_room_src =
            crate::util::strip_comments(include_str!("../components/room_list/edit_room_modal.rs"));
